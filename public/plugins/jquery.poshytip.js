...
(function ($) {
    ...
    var tips = [],
		reBgImage = /^url\(["']?([^"'\)]*)["']?\);?$/i,
		rePNG = /\.png$/i,
		// Changed by sanjay Sep 11 2014
		ie6 = null;//$.browser.msie && $.browser.version == 6;
...
//        var ErrorMessage = this.$elm.attr('ErrorMessage');
...
//        else {
//            
//            $('<div class="', this.opts.className, '">').empty();
//            //           document.body.remove('<div class="', this.opts.className, '">',
//            //				'<div class="tip-inner tip-bg-image"></div>',
//            //				'<div class="tip-arrow tip-arrow-top tip-arrow-right tip-arrow-bottom tip-arrow-left"></div>',
//            //			'</div>');
//        }
    ...
    $.Poshytip.prototype = {
        init: function () {
            ...
            var ErrorMessage = this.$elm.attr('ErrorMessage');
            this.$elm.data('ErrorMessage.poshytip', ErrorMessage !== undefined ? ErrorMessage : null)
				.data('poshytip', this);
        ...
        mouseleave: function (e) {
            ...
            var title = this.$elm.data('ErrorMessage.poshytip');
            if (title !== null)
                this.$elm.attr('ErrorMessage', title);
            if (this.opts.showOn == 'focus')
                return true;
        ...
        update: function (content, dontOverwriteOption) {
            ...
            var self = this,
				newContent = typeof content == 'function' ?
					...
					content == '[ErrorMessage]' ? this.$elm.data('ErrorMessage.poshytip') : content;
        ...
        destroy: function () {
            ...
            delete this.$tip;
            this.content = null;
            this.$elm.unbind('.poshytip').removeData('ErrorMessage.poshytip').removeData('poshytip');
    ...
    $.fn.poshytip.defaults = {
        content: '[ErrorMessage]', // content to display ('[title]', 'string', element, function(updateCallback){...}, jQuery)
