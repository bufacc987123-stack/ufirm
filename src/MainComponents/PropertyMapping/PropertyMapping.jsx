...
const $ = window.$;
class PropertyMapping extends React.Component {
    constructor(props) {
        super(props);
        this.state = { 
            CityData:[],
            GridData:[],
            gridHeader: [
                { sTitle: 'propertyId', titleValue: 'propertyId', "orderable": false },
                { sTitle: 'propertyType', titleValue: 'propertyType',  },
                { sTitle: 'name', titleValue: 'name',  },
                { sTitle: 'contactNumber', titleValue: 'contactNumber',  },
                { sTitle: 'cityName', titleValue: 'cityName',  },
                { sTitle: 'pinCode', titleValue: 'pinCode',  },
