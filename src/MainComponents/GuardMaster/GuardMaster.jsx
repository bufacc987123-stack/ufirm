...
class GuardMaster extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      PageMode: "Home",
      ...
      gridHeader: [
        ...
        { sTitle: "Guard Name.", titleValue: "EmployeeName" },
...
export default connect(mapStoreToprops, mapDispatchToProps)(GuardMaster);
