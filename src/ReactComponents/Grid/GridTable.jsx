...
class GridTable extends React.Component {
    ...
    componentWillMount() {
        this.state.orderedHeader = this.props.TableHeader.sort(this.GetSortOrder("order"));
    }
    ...
    componentWillReceiveProps(props) {
        if (props.TableRow != null) {
            objcommonjs.ClearTableGrid(props.gridID);
        }
    }
    componentDidUpdate() {
        if (this.props.TableRow != null) {
            objcommonjs.ResetGridWithsetting(this.props.gridID, this.props.GridSeetingData);
        }
    ...
    render() {
        return (
            <div className="pr-fullwidth">
                <table id={this.props.gridID} className="table table-striped table-bordered table-hover">
                    <thead>
                        <tr>
                            {this.state.orderedHeader.map((h, i) => (
                                <TableHeader key={h.field} keyHead={h.type} header={h.headerName} />
                            ))}
                        </tr>
                    </thead>
                    <tbody>
                        {this.props.TableRow != null && this.props.TableRow.map((prd, idx) => (
                            <TableRow onRDCallAction={this.RCallAction.bind(this)}
        ...
        return (
            <tr>
                {this.props.headers.map((v, idx) => (
                    <TableRowData onTRDCallAction={this.TRCallAction.bind(this)}
...
class TableRowData extends React.Component {
    ...
    componentWillMount() {
        ...
        if (this.props.headType == 'int') {
            ...
            tempdata = this.props.row[this.props.headfield].toString().replace(
                /\w\S*/g,
                function (txt) {
            ...
            tempdata = dateFormat(this.props.row[this.props.headfield], "dd-mm-yyyy hh:mm:ss");
        }
    ...
    TRDCallAction() {
        let head = this.props.headfield.substring(0, this.props.headfield.length - 2);
    ...
    render() {
        if (this.props.headType == 'action') {
            return (
                ...
                <td><a onClick={this.TRDCallAction.bind(this)}>{this.state.rdata}</a></td>
            );
        }
        else if (this.props.headType == 'hidden') {
            ...
            return (
                <td><a onClick={this.TRDView.bind(this)} title="View" className="fa fa-eye" href="#"></a></td>
            );
        }
        else if (this.props.headType == 'Edit') {
            return (
                <td><a onClick={this.TRDEdit.bind(this)} title="Edit" className="fa fa-edit" href="#"></a></td>
            );
        }
        else if (this.props.headType == 'Delete') {
            return (
                <td><a onClick={this.TRDDelete.bind(this)} title="Delete" className="fa fa-trash" href="#"></a></td>
            );
        }
            ...
            return (
                <td>
                    <a onClick={this.TRDView.bind(this)} title="View" className="fa fa-eye" href="#"></a>
                    <a onClick={this.TRDEdit.bind(this)} title="Edit" className="fa fa-edit" href="#"></a>
                    <a onClick={this.TRDDelete.bind(this)} title="Delete" className="fa fa-trash" href="#"></a>
                </td>
            );
        }
        else if (this.props.headType == 'ViewEdit') {
            ...
            return (
                <td><a onClick={this.TRDMakeActive.bind(this)} title="MakeActive" className="fa fa-eye" href="#"></a></td>
            );
        }
        else if (this.props.headType == 'MakeDeactive') {
            return (
                <td><a onClick={this.TRDMakeDeactive.bind(this)} title="MakeDeactive" className="fa fa-eye-slash" href="#"></a></td>
            );
        } else if (this.props.headType == 'checkbox') {
            return (
                <td className="checkboxtd">
                    <input onClick={this.TRDCallAction.bind(this)} type="checkbox" value={this.props.row[this.props.headfield.substring(0, this.props.headfield.length - 2)]} id={this.props.row[this.props.headfield.substring(0, this.props.headfield.length - 2)]} name={this.props.headfield}></input>
                </td>
            );
        }
        else if (this.props.headType == 'Serial') {
            return (
                <td><span>{this.state.rdata}</span></td>
            );
        }
        else if (this.props.headType == 'status') {
            return (
                <td><span className={this.state.rdata.toLowerCase()}>{this.state.rdata}</span></td>
            );
        }
        //Sanjay Jun 25 2019
        else if (this.props.headType == 'Radio') {
            ...
            return (
                <td> <input onClick={this.TRDRadioClick.bind(this)}
