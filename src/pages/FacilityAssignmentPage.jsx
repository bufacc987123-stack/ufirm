...
import FacilityAssignment from '../MainComponents/FacilityAssignment/FacilityAssignment';
class FacilityAssignmentPage extends React.Component {
    constructor(props) {
        super(props);
        this.state = { 
            PageMode: 'Home',
...
export default FacilityAssignmentPage;